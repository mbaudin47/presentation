...
Computer Physics Communications, 168(2), 78-95.} (\pyvar{CubaIntegration})
\item New class for integration from an existing design of experiment 
(\pyvar{ExperimentIntegration}): also, compute the L2 norm of a function 
(useful for validation of a metamodel).
\item Faster \pyvar{KDTree} implementation using Nanoflann library\footnote{See 
\url{https://github.com/jlblancoc/nanoflann}.}
\item Faster \pyvar{TruncatedDistribution} with n-d CDF inversion
\end{itemize}
